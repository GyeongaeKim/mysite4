					...
					<div id="modifyForm">
						<form action="/mysite4/board/modify" method="get">
							...
							<div class="form-group">
								...
								<input type="text" id="txt-title" name="title" value="${boardMap.TITLE }">
							</div>
							...
							<!-- 내용 -->
							<div class="form-group">
								<textarea id="txt-content" name="content">${boardMap.CONTENT}</textarea>
							</div>
							
							<a id="btn_cancel" href="/mysite4/board/read?no=${param.no }">취소</a>
